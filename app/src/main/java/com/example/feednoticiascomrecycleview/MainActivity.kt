...
import com.example.feednoticiascomrecycleview.databinding.ActivityMainBinding
import org.json.JSONArray


class MainActivity : AppCompatActivity(), OnItemClickListener {

    //Lembrar de incluir a dependência no build.gradle.kts a nível de app para o binding funcionar
    //Inicializar com uma lateinit var chamada binding do tipo ActivityMainBinding
    ...
    private var listaNoticias: List<NoticiaModel> = listOf()
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding.recyclerView.adapter = NoticiaAdapter(listaNoticias, Glide.with(this), this)
            NoticiaAdapter(listaNoticias, Glide.with(this), this@MainActivity)
        }
        ...
        private fun lerJson(context: Context): List<NoticiaModel> {
            ...
            Log.w(
                ...
                "lerJson: Atenção! Essa operação pode resultar numa exceção"
            )
            ...
            try {
                ...
                for (i in 0 until jsonArray.length()) {
                    ...
                    Log.d(
                        this.javaClass.simpleName,
                        "Objeto de titulo $newsTitle foi criado com sucesso!"
                    )
